/**
 * 📊 MIGRACIÓN: Contadores Atómicos de Boletos y Oportunidades en Tabla Rifas
 * 
...
exports.up = async function (knex) {
  console.log('🚀 Iniciando migración: Añadir columnas de contadores atómicos a la tabla "rifas"...');
...
exports.down = async function (knex) {
  console.log('↩️ Revirtiendo migración: Eliminar columnas de contadores de la tabla "rifas"...');
